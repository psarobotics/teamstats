...
# with pd.ExcelWriter('Nationals_results.xlsx') as writer:  # pylint: disable=abstract-class-instantiated
...
# with pd.ExcelWriter('Nationals_tables.xlsx') as writer:  # pylint: disable=abstract-class-instantiated
