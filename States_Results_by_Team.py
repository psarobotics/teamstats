...
# with pd.ExcelWriter('States_results_team.xlsx') as writer:  # pylint: disable=abstract-class-instantiated
...
# with pd.ExcelWriter('states_tables_team.xlsx') as writer:  # pylint: disable=abstract-class-instantiated
