...
# with pd.ExcelWriter('States_results_All.xlsx') as writer:  # pylint: disable=abstract-class-instantiated
...
with pd.ExcelWriter('States_tables_All.xlsx') as writer:  # pylint: disable=abstract-class-instantiated
